    ...
    <div className={`bg-white border-2 border-black rounded-lg overflow-hidden shadow-none ${className}`} style={{ boxShadow: 'none' }}>
      ...
      <div className="flex h-24">
        ...
        <div className="w-2/5 flex flex-col justify-center relative border-r-2 border-black">
          {/* 角色圖片 */}
          <div className="flex-1 flex items-center justify-center p-2 h-16 overflow-hidden">
          ...
          {/* 藍色姓名條 */}
          <div 
            className="px-2 py-1 text-center h-8 flex items-center justify-center"
        ...
        {/* 右側：文字內容區域 */}
          <div className="flex-1 p-3 flex flex-col justify-center space-y-1 max-w-xs sm:max-w-sm md:max-w-md">
          {/* 職業標題 */}
        ...
        {/* 底部 Slogan 區域 */}
        <div className="bg-black text-center py-2 h-8 flex items-center justify-center">
        <span 
